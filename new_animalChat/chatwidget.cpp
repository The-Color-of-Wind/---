    ...
    , ui(new Ui::ChatWidget)
{
    ...
    connect(ServerConnect::instance(), &ServerConnect::getChatsSuccess, this, &ChatWidget::showChatsListWidegt);
    connect(ServerConnect::instance(), &ServerConnect::receiveMessageSuccess, this, &ChatWidget::receiveMessage);

    //读取不在线时的聊天记录
    connect(ServerConnect::instance(), &ServerConnect::getFriendsUnreadMessagesSuccess, this, &ChatWidget::addFriendsUnreadMessages);

    //connect(ServerConnect::instance(), &ServerConnect::accpetFriendSuccess, this, &ChatWidget::updateChatsList);
...
void ChatWidget::addFriendsUnreadMessages(QVector<Message> friendsUnreadMessages)
{
    ...
    //ServerConnect::instance()->sendData(docChatting.toJson()+ "\n");
    ServerConnect::instance()->sendData(docChatting.toJson());
