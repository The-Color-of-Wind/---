    ...
    , ui(new Ui::FriendWidget)
{
    ...
    connect(ServerConnect::instance(), &ServerConnect::getFriendsSuccess, this, &FriendWidget::showFriendsListWidegt);
    connect(ServerConnect::instance(), &ServerConnect::getUserInformation, this, &FriendWidget::showSearchUserInformation);
    connect(ServerConnect::instance(), &ServerConnect::getUserInformationError, [&]() {
        ui->widget->hide();
    ...
    connect(ServerConnect::instance(), &ServerConnect::deleteFriendSuccess, [&](QString userId, QString friendId){
    ...
    //connect(ServerConnect::instance(), &ServerConnect::accpetFriendSuccess, this, &FriendWidget::updateAcceptSuccess);
