...
void ServerConnect::initConnect() {
    ...
    connect(socket, &QTcpSocket::readyRead, this, &ServerConnect::onReadyRead);
...
// QPixmap ServerConnect::loadImageFromBase64(const QString &base64Data) {
//     // Base64解码
//     QByteArray decodedData = QByteArray::fromBase64(base64Data.toUtf8());

//     // 将解码后的数据加载到 QPixmap 中
//     QPixmap pixmap;
